...
fn test(ctx: &mut TestCtx, mut args: TestArgs) -> Result<()> {
    ...
    let fields = [
        ...
        ( "SceneAdditiveSingleLoadProgress5", "0.899999976158142", "Progress mismatch" ),
        ...
        ( "SceneAdditiveSingleLoadProgress7", "1", "Scene should be loaded" ),
        ( "SceneAdditiveSingleLoadProgress8", "0", "Scene shouldn't be loaded" ),
        ( "SceneAdditiveSingleLoadProgress9", "0.899999976158142", "Scene should be loading" ),
        ( "SceneSingleAdditiveLoadProgress", "0", "Scene shoudn't be loading" ),
        ( "SceneSingleAdditiveLoadProgress2", "0", "Scene shouldn't be loading" ),
        ( "SceneSingleAdditiveSceneCount", "6", "There has to be 6 loading scenes" ),
        ( "SceneSingleAdditiveLoadedSceneCount", "1", "Loaded scene count has to be 1" ),
        ( "SceneSingleAdditiveLoadProgress3", "0", "Scene shouldn't be loading" ),
        ( "SceneSingleAdditiveLoadProgress4", "0", "Scene shouldn't be loading" ),
        ( "SceneSingleAdditiveLoadProgress5", "0.899999976158142", "Scene should be ready" ),
        ( "SceneSingleAdditiveLoadProgress6", "0.899999976158142", "Scene should be ready" ),
        ( "SceneSingleAdditiveLoadedSceneCount2", "2", "Empty scene 1 just loaded" ),
        ( "SceneSingleAdditiveLoadedSceneCount3", "3", "Empty scene 2 just loaded" ),
        ( "SceneSingleAdditiveLoadedSceneCount4", "4", "Empty scene 3 just loaded" ),
    ];
